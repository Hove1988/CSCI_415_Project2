...
class md5{
    private:
        ...
        const int x[] = {7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 
        ...
        /********** MD5 operations **********/
        inline int F(int x, int y, int z) { return ((x & y) | (~x & z)); }
        inline int G(int x, int y, int z) { return ((x & z) | (y & ~z)); }
        inline int H(int x, int y, int z) { return (x ^ y ^ z); }
        inline int I(int x, int y, int z) { return (y ^ (x | ~z)); }
